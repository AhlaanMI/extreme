...
export const SERVICES = [
    {
        ...
        description: "One-on-one sessions tailored to your goals and current fitness level.",
        features: ["Personalized coaching", "Flexible scheduling", "Goal tracking"],
    },
    {
        icon: "Apple",
        title: "Nutrition Consulting",
        description: "Practical nutrition guidance to support your training and recovery.",
    ...
    },
    {
        icon: "Trophy",
        title: "Body Building",
        description: "Focused strength and muscle-building programs for serious goals.",
        features: [
    ...
    },
    {
        ...
        description: "Full-body conditioning to improve stamina, mobility, and overall fitness.",
...
export const TESTIMONIALS = [
    {
        name: "Mohamed Rifky",
        content: "One of the best gyms in Mawanella! Well-maintained equipment, clean environment, and very supportive trainers who guide you every step of the way. Great place for both beginners and experienced fitness enthusiasts.",
        rating: 5,
    },
    {
        name: "Sanidu Abeywickrama",
        content: "If you are serious about getting fit and want a gym that offers both quality equipment and expert guidance, Extreme Fitness Center is the place to be. Highly recommend!",
        rating: 5,
    },
    {
        name: "udara gunathilake",
        content: "Extreme Fitness Center in Mawanella is a great place for anyone looking to stay fit. The gym has high-quality equipment, a clean environment, and a friendly atmosphere. Trainer and owner Nirosha ayya is very supportive and knowledgeable, helping members achieve their fitness goals.",
        rating: 5,
    },
    {
        name: "chandima tharanga",
        content: "The gym is well-maintained, not too crowded, and offers genuine supplements for those who need them. With excellent service and affordable pricing, it is a perfect place for workouts and bodybuilding. Highly recommended!",
        rating: 5,
    },
];
...
export const FAQ = [
    ...
    },
    {
        ...
        answer: "Yes. We run youth classes designed for safe, age-appropriate training.",
    },
    {
        question: "Do you provide nutrition consulting?",
        answer: "Yes. Our nutrition consulting supports your training and recovery goals.",
    },
    {
        question: "What services do you offer?",
        answer: "Private lessons, personal training, nutrition consulting, youth classes, body building, fitness training, and weight training.",
    },
    {
        question: "What should I bring for my first session?",
        answer: "Comfortable workout clothes, water, and a willingness to learn. Our coaches will guide you.",
    },
];
export const TRANSFORMATIONS = [
    {
        before: "https://images.unsplash.com/photo-1506126613408-eca07ce68773?w=300&h=400&fit=crop",
        after: "https://images.unsplash.com/photo-1517836357463-d25ddfcbf042?w=300&h=400&fit=crop",
        name: "Member Story",
