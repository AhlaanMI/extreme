...
function App() {
  ...
  return (
    <div className="relative min-h-screen overflow-x-clip noise-overlay">
      ...
      <Navbar />
      <main className="pb-28 pt-16 sm:pb-24 sm:pt-20 md:pb-0">
        <Hero />
        <TrustStrip />
      ...
      <a
        ...
        className="fixed bottom-3 left-3 right-3 z-40 justify-center text-sm shadow-lg md:hidden btn btn-primary"
